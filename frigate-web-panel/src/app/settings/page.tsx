  ...
  return (
    <div className="bg-gray-800 rounded-xl p-6 space-y-4">
      <div className="flex items-center gap-3">
        <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-gray-700 text-cyan-400">
          {icon}
        </div>
...
const inputClass =
  "w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2.5 text-gray-200 text-sm placeholder-gray-600 focus:outline-none focus:border-cyan-600 focus:ring-1 focus:ring-cyan-600 transition-colors";
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        ...
        <div className="flex items-center justify-between pb-6">
          <button
            onClick={handleSave}
            disabled={saving}
            className="bg-cyan-600 hover:bg-cyan-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-medium rounded-lg px-6 py-2.5 transition-colors flex items-center gap-2"
          >
            {saving ? (
              <>
